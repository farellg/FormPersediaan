            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header text-center">
                        {{-- <img alt="PERSEDIAAN logo" class="mx-auto" src="/image/onlylogo.svg" height="50"/> --}}
                    ...
                    <div class="card-body m-2">
                        <form action="{{ route('register') }}" method="POST">
                            @csrf
                            <input type="hidden" name="role" value="admin"> <!-- Default role: admin -->
                            <div class="mb-3">
                        ...
                        <div class="text-center mt-3">
                            <p>Kembali ke <a href="{{ route('login') }}">Log in</a></p>
                        </div>
                        <div class="text-center mt-3">
                            <p>Ingin mendaftar sebagai user? <a href="{{ route('register') }}" class="btn btn-outline-secondary btn-sm">Registrasi User</a></p>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    // Fungsi toggle visibility untuk setiap field
    function setupToggleVisibility(inputId, toggleButtonId) {
    ...
    // Setup untuk setiap input field
    setupToggleVisibility('password', 'togglePassword');
    setupToggleVisibility('password_confirmation', 'toggleConfirmPassword');
    setupToggleVisibility('passcode', 'togglePasscode');
</script>
</html>
